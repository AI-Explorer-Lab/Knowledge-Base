...
| `TK-GDL-004` | 将代码变更审批绑定到精确的 Diff 哈希和提交主题 | `guideline` | `verified` | `team` | `-` | approval, diff-hash, commit-subject, integrity, git | `tech-wiki/guidelines/TK-GDL-004.md` |
...
| `TK-GDL-007` | 端到端扩展区间筛选时统一查询与计数语义 | `guideline` | `verified` | `team` | `-` | range-filter, pagination, query-consistency, backend | `tech-wiki/guidelines/TK-GDL-007.md` |
...
| `TK-GDL-009` | 将本地化数值格式化限制在展示层 | `guideline` | `verified` | `team` | `-` | frontend, presentation-layer, localization, number-formatting, data-integrity | `tech-wiki/guidelines/TK-GDL-009.md` |
